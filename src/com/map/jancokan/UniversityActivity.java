...
public class UniversityActivity extends Activity {
	...
	public final static String UNIVERSITY_LOCATION = "com.map.jancokan.LOCATE_MESSAGE";
	...
	protected void onCreate(Bundle savedInstanceState) {
        ...
        if(cursor.getCount() >= 1){
        	...
        	universityName.setText(cursor.getString(cursor.getColumnIndex("universityName")));
        	
        	universitySureName = (TextView) findViewById(R.id.university_description);
        	universitySureName.setText(cursor.getString(cursor.getColumnIndex("universitySureName")));
